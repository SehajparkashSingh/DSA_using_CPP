...
void print_queue1(queue *q,int size){      //recursive function
    if(size){
        int t= dequeue1(q);
        cout<<t<<" ";
        enqueue(q,t);
...
void print_in_reverse(queue *q,int size){ //recusive function
    if(size){
        int t=dequeue1(q);
        enqueue(q,t);
        print_in_reverse(q,--size);
        cout<<t<<" ";
    }
    else 
        return;
...
void print_in_reverse_with_stack(queue *q){
...
int main(){
    ...
    enqueue(q,6);
    print_queue(q);
    print_queue1(q,q->present_sz);
    print_in_reverse(q,q->present_sz);
    cout<<endl<<endl;
    print_in_reverse_with_stack(q);
}